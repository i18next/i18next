  ...
  _createClass(I18n, [{
    ...
    value: function init(options, callback) {
      ...
      if (options.compatibilityAPI === 'v1') {
        this.options = utils.defaults({}, (0, _defaults.transformOptions)(compat.convertAPIOptions(options)), (0, _defaults.get)());
      } else if (options.compatibilityJSON === 'v1') {
        this.options = utils.defaults({}, (0, _defaults.transformOptions)(compat.convertJSONOptions(options)), (0, _defaults.get)());
      } else {
        this.options = utils.defaults(this.options, (0, _defaults.transformOptions)(options), (0, _defaults.get)());
      }
      ...
      if (!this.options.isClone) {
        ...
        if (this.modules.backend) {
          s.backendConnector = new _BackendConnector2['default'](createClassOnDemand(this.modules.backend), createClassOnDemand(this.modules.cache), s.resourceStore, s, this.options);
    ...
    value: function addPostProcessor(name, fc) {
    ...
    value: function cloneInstance(options, callback) {
      ...
      var clone = new I18n(utils.extend(options, this.options, { isClone: true }), callback);
