...
var Translator = (function (_EventEmitter) {
  ...
  _createClass(Translator, [{
    ...
    value: function extendTranslation(res, key, options) {
      ...
      if (res !== undefined && postProcessorNames && postProcessorNames.length && options.applyPostProcessor !== false) res = _postProcessor2['default'].handle(postProcessorNames, res, key, options, this);
