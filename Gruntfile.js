...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    jade: {
      compile: {
        ...
        files: [
          ...
          {'node/index.html': [ 'src/jade/node/index.jade' ] },
          { expand: true, cwd: 'src/jade/node/pages/', src: ['**/*.jade'], dest: 'node/pages/', ext: '.html' }
        ]
      }
    },
    ...
    copy: {
      dist: {
        files: [
          { expand: true, cwd: 'public/test/locales', src: ['**'], dest: 'pages/locales/' }
        ]
      }
    },
  ...
  grunt.registerTask('default', ['clean', 'jade', 'prettify', 'stylus', 'copy', 'cssmin']);
