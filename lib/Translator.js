...
var Translator = (function (_EventEmitter) {
  ...
  _createClass(Translator, [{
    ...
    value: function translate(keys) {
      ...
      // array special treatment
        ...
        // string, empty or null
            ...
            if (this.options.appendNamespaceToMissingKey && res === key) res = namespace + ':' + key;
    ...
    value: function extendTranslation(res, key, options) {
      ...
      if (res !== undefined && postProcessorNames && postProcessorNames.length) res = _postProcessor2['default'].handle(postProcessorNames, res, key, options);
    ...
    value: function resolve(keys) {
      ...
      keys.forEach(function (key) {
        ...
        var namespaces = options.ns || _this2.options.defaultNS;
        var nsSeparator = options.nsSeparator || _this2.options.nsSeparator || ':';
        if (key.indexOf(nsSeparator) > -1) {
          var parts = key.split(nsSeparator);
          namespaces = parts[0];
          key = parts[1];
        ...
        var codes = _this2.languageUtils.toResolveHierarchy(options.lng || _this2.language);
